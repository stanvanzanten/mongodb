...
var userroutes_v1 = require('./api/voorstelling.routes.v1');
var filmroutes_v1 = require('./api/film.routes.v1');
var bioscopenroutes_v1 = require('./api/bioscopen.routes.v1');
...
app.use(function (req, res, next) {
    ...
    res.setHeader('Access-Control-Allow-Origin', process.env.ALLOW_ORIGIN || 'http://localhost:5000');
...
app.use('/api/v1', bioscopenroutes_v1);
